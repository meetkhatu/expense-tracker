        ...
        <div className='flex'>
            ...
            <div className='hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative'>
                ...
                <div className='grid grid-cols-1 z-20'>
                    <StatsInfoCard icon={<LuTrendingUpDown />} label="Track Your Income & Expenses" value="43,000" color="bg-primary" />
                </div>
                <img src={bargraph} className='rounded-3xl w-64 lg:w-[90%] absolute bottom-10 shadow-lg shadow-blue-200' />
            </div>
